...
class BrightcoveNewIE(BrightcoveNewBaseIE):
    ...
    def _real_extract(self, url):
        ...
        api_url = f'https://edge.api.brightcove.com/playback/v1/accounts/{account_id}/{content_type}s/{video_id}'
        headers = {}
        ...
        if referrer:
            headers.update(
                {
                    'Referer': referrer,
                    'Origin': re.search(r'https?://[^/]+', referrer)[0],
                }
            )
